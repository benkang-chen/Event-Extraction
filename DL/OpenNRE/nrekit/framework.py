...
class ReFramework:
    ...
    """
    # Train and test the model at bag level.
    MODE_BAG = 0
    # Train and test the model at instance level
    MODE_INS = 1

    def __init__(self, train_data_loader, test_data_loader, max_length=120, batch_size=160):
        """
        class construction function, framework initialization
    ...
    def one_step_multi_models(self, sess, models, batch_data_gen, run_array, return_label=True):
        ...
        for model in models:
            ...
            # mask data is used in PCNN models
    ...
    def train(self, model, model_name, ckpt_dir='./checkpoint', summary_dir='./summary',
        ...
        # Init
        # allow cpu computing if there is no gpu available
        # allow_soft_placement=True 如果没有gpu则允许使用cpu进行计算
        # log_device_placement=True 打印执行操作的所有设备
